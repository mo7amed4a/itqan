...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "absolute size-8 rounded-full flex flex-col items-center bg-transparent border-none",
        orientation === "horizontal"
...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "absolute h-8 w-8 rounded-full flex flex-col items-center bg-transparent border-none",
        orientation === "horizontal"
