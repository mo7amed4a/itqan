...
export default function VideoCall({dataVideoCall}: {dataVideoCall: TFunction<"home", undefined>, locale: string}) {
  return (
        ...
        <div className='group relative'>
            <div className='bg-gray-100 max-w-screen-md flex items-center mx-auto rounded-full !h-28 md:!h-80 py-3'>
                <div className='md:h-80 md:w-80 md:p-4 group-hover:order-2'>
                    <Image className='rounded-full !h-28 md:!h-full !w-28 md:!w-full duration-300 border-4 md:border-8 border-primary/20' src={img} alt='video call' width={300} height={300} />
                </div>
