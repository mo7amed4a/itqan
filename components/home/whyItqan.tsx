    ...
    <div className="bg-orange-50 h-auto">
      <div className="flex flex-col-reverse md:flex-row items-center md:gap-x-20 py-10 px-4 container mx-auto">
        <div className="space-y-4 lg:w-3/5">
          <h1 className="text-lg md:text-3xl md:text-start  text-primary font-bold">
            {data.why_title}
          </h1>
          <div
            className="custom-bullet [&>ul]:md:text-2xl [&>ul]:text-start [&>ul]:items-start [&>ul]:space-y-1 [&>ul]:md:ps-2"
